...
export function PortfolioDashboardV3() {
  ...
  return <main className="raoniPortfolio">
    ...
    <section className="marketStrip" aria-label="시장 요약"><article><span>PORTFOLIO VALUE</span><strong>{pending ? "USD/KRW 대기" : formatKrw(totalValue)}</strong><small>평가 손익 {pending ? "—" : formatKrw(totalValue - totalCost)}</small></article><article><span>USD / KRW</span><b>{market.usdKrw === null ? "—" : formatKrw(market.usdKrw)}</b><small>ExchangeRate API 일일 기준</small></article><article><span>USDT / KRW</span><b>{market.usdtKrw === null ? "—" : formatKrw(market.usdtKrw)}</b><small>Upbit KRW-USDT</small></article></section>
